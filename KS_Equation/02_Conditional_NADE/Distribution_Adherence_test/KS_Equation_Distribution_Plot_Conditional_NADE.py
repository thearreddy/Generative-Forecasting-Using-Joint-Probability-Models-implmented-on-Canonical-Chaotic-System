...
LOG_FILE = OUTPUT_DIR / "conditional_nade_outputs.txt"
...
def forecast_trajectory(dataset, mean_window, std_window, model, device):
    ...
    forecast_path = OUTPUT_DIR / "conditional_nade_forecasted_trajectory.npy"
...
def plot_distribution_adherence(dataset, forecasted_trajectory):
    ...
    hist_path = OUTPUT_DIR / "conditional_nade_distribution_histograms.txt"
    np.savetxt(
        hist_path,
    ...
    figure_path = OUTPUT_DIR / "conditional_nade_distribution_adherence.png"
...
def main():
    ...
    write_log(f"Output folder: {OUTPUT_DIR}")
